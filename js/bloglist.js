...
async function displayBlogPosts() {
  try {
    ...
    for (const post of posts) {
      ...
      readMoreButton.classList.add("blog-button", "right-align"); // Add both classes here
      ...
      postContainer.appendChild(buttonContainer); // Place the button container inside the post container
